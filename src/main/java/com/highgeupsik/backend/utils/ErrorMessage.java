...
public class ErrorMessage {
    ...
    public static final String NOT_ROOM_USER = "대화방 사용자가 아닙니다.";
    public static final String TOKEN_EXPIRED = "만료된 토큰입니다.";
    public static final String UNABLE_JWT_SIGNATURE = "잘못된 JWT 서명입니다.";
    public static final String UNSUPPORTED_JWT_TOKEN = "지원하지 않는 JWT 토큰입니다.";
